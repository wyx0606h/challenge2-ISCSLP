...
def add_lora_to_model(
    ...
    # The training path uses standard torch Linear modules, not torchao quantized
    # tensors. Some environments still have old torchao installed, and recent
    # PEFT raises during availability probing instead of simply skipping the
    # torchao dispatcher. Force PEFT to bypass that optional path.
    peft_import_utils.is_torchao_available = lambda: False
    if peft_lora_torchao is not None:
